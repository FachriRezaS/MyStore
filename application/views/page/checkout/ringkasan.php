            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="btn-group btn-group-justified" role="group" aria-label="Justified button group">
                        ...
                        <a href="<?php echo site_url('tarif') ?>" class="btn btn-default" role="button">Tarif Pengiriman <i class="fa fa-angle-double-right"></i></a>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p class="no-margin"><?php echo $item['option']['color'] ?></p>
                                                    <p class="no-margin"><?php echo $item['qty'] ?></p>
                                                    <p class="no-margin">Rp <?php echo number_format( $item['price'], 0, ',', '.') ?></p>
                                                </td>
                                                <td>
                                                    <h5 class="no-margin">Rp <?php echo number_format($item['subtotal'], 0, ',', '.') ?></h5>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                            <tr>
                                                <th>Tarif Pengiriman</th>
                                                <th>Rp <?php echo number_format($this->session->userdata('tarif_akhir'), 0, ',', '.') ?></th>
                                            </tr>
                                            <tr>
                                                <th><h3 class="no-margin">Total Biaya</h3></th>
                                                <th><h3 class="no-margin">Rp <?php echo number_format ($this->cart->total(), 0, ',', '.') ?></h3></th>
                                            </tr>
                                        </tbody>
                                    </table>
