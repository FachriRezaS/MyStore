                ...
                <div class="col-md-10">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <h5 class="no-margin">No Rek: 11110393 A/N XXXX</h5>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <h5 class="no-margin">Tanggal: <?php echo $order->tanggal ?></h5>
                            <h5 class="no-margin">Total: Rp <?php echo number_format($order->total_harga , 0, ',', '.') ?></h5>
